%DemoTest_PCA_ThermalData_Disgust_10Feb2015_Glasses


%folderName = 'D:\Important BackUpApr01\Database\Thermal Data\Thermal Database\';
...
for temp=1:1:10
   ...
   % d=[expMatrix;expWAMatrix;expWHMatrix;expWFMatrix;expWNMatrix;expWSaMatrix;]
    ...
    xlswrite('D:\LVThS K27\PCA_Thermalimg v5\Result0.4\disgust04.xls',d);
