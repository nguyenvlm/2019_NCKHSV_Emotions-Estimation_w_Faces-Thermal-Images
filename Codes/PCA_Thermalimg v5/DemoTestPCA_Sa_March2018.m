%DemoTest_PCA_ThermalData_Sad_10Feb2015_NoGlasses
...
for temp=1:1:10
   ...
   % xlswrite('../results/PCA2/NoGlass/sadness.xls',d);

xlswrite('D:\LVThS K27\PCA_Thermalimg v5\ResultNotROIs\sadness2018.xls',d);
